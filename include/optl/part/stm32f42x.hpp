...
#ifndef OPTL_STM32F42X_INCLUDED
#define OPTL_STM32F42X_INCLUDED
...
template<> class PinAf<SPI5> : public PinAfDef<GPIO_AF5> {};
template<> class PinAf<SPI6> : public PinAfDef<GPIO_AF5> {};
...
template<> class PinAf<UART7> : public PinAfDef<GPIO_AF8> {};
template<> class PinAf<UART8> : public PinAfDef<GPIO_AF8> {};
